...
export default function InternalMobileNavigation({ 
  ...
  return (
    <>
        ...
        <div className="p-2 space-y-1">
          {showAdminLink && (
            <Link
              href="/admin"
              onClick={handleLinkClick}
              className="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 hover:scale-105 hover:bg-red-500/10"
            >
          ...
          <button
            ...
            className="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 hover:scale-105 hover:bg-red-500/10 w-full text-left"
          >
            <span className="text-xl">👋</span>
      ...
      {/* 👤 USER INFO */}
      <div 
        className={`fixed bottom-6 left-1/2 transform -translate-x-1/2 px-6 py-3 rounded-2xl backdrop-blur-xl transition-all duration-300 md:hidden z-50 ${
