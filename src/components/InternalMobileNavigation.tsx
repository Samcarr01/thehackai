      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="border-t border-gray-700 p-4 space-y-3">
            {/* Settings Link - MADE VERY OBVIOUS FOR DEBUG */}
            <Link
              href="/settings"
              onClick={handleLinkClick}
              className="flex items-center px-3 py-3 rounded-lg transition-all duration-200 min-h-[44px] group bg-red-500 text-white border-4 border-yellow-400 shadow-2xl"
            >
