          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <button
                ...
                className="w-full inline-flex justify-center items-center py-3 px-4 rounded-xl border border-gray-200 bg-slate-800/80 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 shadow-sm hover:shadow-md group mobile-touch-target touch-feedback"
              >
