    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-purple-50/30 to-white relative">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-6 leading-tight text-center min-h-[120px] sm:min-h-[140px] md:min-h-[160px] lg:min-h-[200px] xl:min-h-[240px] flex items-center justify-center">
            <TypewriterText 
              texts={[
